...
try {
    ...
    foreach ($row in $decks) {
        ...
        try {
            ...
            $geometry | ConvertTo-Json -Depth 12 | Set-Content -LiteralPath $geometryPath -Encoding utf8
...
$results | ConvertTo-Json -Depth 6 | Set-Content -LiteralPath $RenderIndexJson -Encoding utf8
